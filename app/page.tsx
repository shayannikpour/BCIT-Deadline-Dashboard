    ...
    <main className="min-h-screen bg-background text-foreground">
      <div className="mx-auto w-full max-w-[1180px] px-5 pb-16 pt-6 sm:px-8 lg:px-10">
              ...
              return (
                ...
                >
                  ...
                  <div className="sm:text-right">
                    <span
                      className={`inline-flex rounded-full px-3 py-1.5 text-xs font-semibold ${item.submitted ? 'bg-emerald-50 text-emerald-700' : 'bg-muted text-muted-foreground'}`}
                    >
                      {item.submitted
                        ? 'Submitted'
        ...
        <p className="mt-6 text-xs text-muted-foreground">
          Connect and Cengage MindTap dates were added from your screenshots.
          Connect times retain the PDT label shown there, including December;
          11:59 PM PDT equals 10:59 PM Vancouver standard time in December.
          SimNet dates were interpreted as Vancouver local time because the
          screenshots omitted the time zone.
        </p>
